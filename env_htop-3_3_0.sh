...
export CURRENT_PATH=/home/j.cooke/modules/htop-3.3.0
export CLUSTER_DIRECTORY=/shared/EL9/explorer
export SOFTWARE_NAME=htop
export SOFTWARE_VERSION=3.3.0

export GITHUB_URL=https://github.com/northeastern-rc-software-modules/htop-3.3.0
